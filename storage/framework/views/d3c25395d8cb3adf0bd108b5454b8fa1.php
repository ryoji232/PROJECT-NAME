...
<div class="alpha-jump-bar" id="alphaJumpBar">
    <?php $__currentLoopData = range('A','Z'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $letter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if(in_array($letter, $presentLetters)): ?>
            <a href="#shelf-<?php echo e($letter); ?>" class="alpha-letter" data-letter="<?php echo e($letter); ?>"><?php echo e($letter); ?></a>
        <?php else: ?>
            <a class="disabled-letter" aria-disabled="true"><?php echo e($letter); ?></a>
        <?php endif; ?>
...
<div id="availableBooks">
    <?php $__empty_1 = true; $__currentLoopData = $grouped; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $letter => $letterBooks): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="shelf-section" id="shelf-<?php echo e($letter); ?>" data-shelf="<?php echo e($letter); ?>">

            <!-- Section header -->
            <div class="shelf-label">
                <div class="shelf-letter-badge"><?php echo e($letter); ?></div>
                <hr class="shelf-rule">
                <span class="shelf-label-text">
                    <?php echo e($letterBooks->count()); ?> <?php echo e(Str::plural('title', $letterBooks->count())); ?>
            ...
            <div class="row g-3 shelf-cards">
                <?php $__currentLoopData = $letterBooks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-md-4 book-card"
                         ...
                         id="book-card-<?php echo e($book->id); ?>">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <form class="borrow-form mb-3" data-book-id="<?php echo e($book->id); ?>">
                            ...
                            <div class="d-flex flex-column gap-2">
                                ...
                                <button type="submit" class="btn btn-success btn-sm w-100 borrow-btn"
                                        data-book-id="<?php echo e($book->id); ?>">BORROW</button>
                            </div>
                        </form>
                    <?php endif; ?>
                    ...
                    <div class="d-flex flex-column gap-2">
                        ...
                        <a href="<?php echo e(route('books.edit', $book->id)); ?>" class="btn btn-primary btn-sm w-100">EDIT BOOK</a>
