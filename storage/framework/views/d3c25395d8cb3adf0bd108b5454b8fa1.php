    ...
    <?php $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="historyModalLabel<?php echo e($book->id); ?>">
                            Borrow History — <?php echo e($book->title); ?>
                    ...
                    <div class="modal-body">
                        <?php if($bookHistory->count() > 0): ?>
                            <p class="fw-semibold">
                                Total Borrowed:
                                <span class="text-primary"><?php echo e($bookHistory->count()); ?></span> time(s)
                            </p>
                            <canvas id="historyChart<?php echo e($book->id); ?>" height="100"></canvas>
                            <hr>
                            <ul class="list-group list-group-flush">
                                <?php $__currentLoopData = $bookHistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $history): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="list-group-item">
                                        <strong><?php echo e($history->student_name); ?></strong><br>
                                        <small>
                                            Borrowed on
                                            <?php echo e(\Carbon\Carbon::parse($history->borrowed_at ?? $history->created_at)
                                        ...
                                        <?php if($history->returned_at): ?>
                                            <br><span class="text-success">
                                                Returned on
                                                <?php echo e(\Carbon\Carbon::parse($history->returned_at)
                                                    ->timezone('Asia/Manila')->format('M d, Y - h:i A')); ?>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                const ctx = document.getElementById('historyChart<?php echo e($book->id); ?>');
                if (ctx) {
                    new Chart(ctx, {
                        type: 'pie',
                        data: {
                            ...
                            datasets: [{
                                data: [<?php echo e($book->copies); ?>, <?php echo e($notReturnedCount); ?>],
