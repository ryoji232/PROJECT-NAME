        ...
        <form method="GET" action="<?php echo e(route('book-history.index')); ?>">
            <div class="row g-3">
                ...
                <div class="col-md-3 d-flex align-items-end gap-2">
                    ...
                    <a href="<?php echo e(route('book-history.index')); ?>" class="btn btn-light">
                        Clear
                    </a>
                </div>
            </div>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $borrowings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $borrowing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e($borrowing->borrowed_at ? $borrowing->borrowed_at->format('M d, Y h:i A') : 'N/A'); ?></td>
                                <td><?php echo e($borrowing->due_date ? $borrowing->due_date->format('M d, Y') : 'N/A'); ?></td>
                                <td>
                                    <?php if($borrowing->returned_at): ?>
                                        <?php echo e($borrowing->returned_at->format('M d, Y h:i A')); ?>
                                ...
                                <td>
                                    ...
                                    <?php elseif($borrowing->due_date && now()->greaterThan($borrowing->due_date)): ?>
