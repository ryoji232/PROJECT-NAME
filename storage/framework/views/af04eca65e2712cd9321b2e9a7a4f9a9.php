            ...
            <form action="<?php echo e(route('books.update', $book->id)); ?>" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="copies" class="form-control"
                           value="<?php echo e(old('copies', $book->copies)); ?>" min="1" max="10" required>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\project-name\resources\views/books/edit.blade.php ENDPATH**/ ?>