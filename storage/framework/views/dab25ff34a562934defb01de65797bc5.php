...
<div class="container">
    <div class="brand-with-profile">
        ...
        <div class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end profile-dropdown" aria-labelledby="profileDropdown">
                ...
                <li><a class="dropdown-item" href="<?php echo e(route('librarian.profile')); ?>">
                    <span>👤 Profile</span>
                </a></li>
                <li><a class="dropdown-item" href="<?php echo e(route('librarian.account')); ?>">
                    <span>⚙️ Account</span>
                </a></li>
                <li><hr class="dropdown-divider"></li>
                <li>
                    <!-- Logout Form -->
                    <form id="logout-form" action="<?php echo e(route('librarian.logout')); ?>" method="POST" style="display: none;">
                        <?php echo csrf_field(); ?>
                    </form>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto align-items-center">
            <li class="nav-item">
                <a class="nav-link <?php echo e(request()->routeIs('books.index') ? 'active' : ''); ?>" href="<?php echo e(route('books.index')); ?>">Books</a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?php echo e(request()->routeIs('borrowings.index') ? 'active' : ''); ?>" href="<?php echo e(route('borrowings.index')); ?>">Borrowed Books</a>
            </li>
            <li class="nav-item">
    <a class="nav-link <?php echo e(request()->routeIs('book-history.index') ? 'active' : ''); ?>" href="<?php echo e(route('book-history.index')); ?>">Book History</a>
</li>
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-notification" aria-labelledby="navbarDropdown">
                    ...
                    <?php else: ?>
                        <?php $__currentLoopData = $notificationList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
