...
<body>
    ...
    <div class="sticker">
        ...
        <div class="barcode-box">
            ...
            <div class="barcode-number" id="barcodeLabel">ID: <?php echo e($book->id); ?></div>
        </div>
        ...
        <div class="book-info">
            ...
            <p><strong>Status:</strong>
                <span id="stickerStatus" class="<?php echo e($book->available_copies > 0 ? 'status-available' : 'status-borrowed'); ?>">
    ...
    (function () {
        ...
        var activeCopyStatus     = '<?php echo e($book->available_copies > 0 ? "available" : "borrowed"); ?>';
        ...
        function downloadBarcode() {
            ...
            img.onload = function () {
                ...
                link.download = 'barcode-<?php echo e($book->id); ?>.png';
...
</html><?php /**PATH C:\xampp\htdocs\PROJECT-NAME-main\resources\views/books/barcode-sticker.blade.php ENDPATH**/ ?>