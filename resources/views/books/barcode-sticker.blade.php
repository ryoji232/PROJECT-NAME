...
@endif
    <div class="sticker">
        ...
        <div class="barcode-box">
            <svg id="barcode"></svg>
            <div class="barcode-number">ID: {{ $book->id }}</div>
        </div>
        
        <div class="book-info">
            <p><strong>Copies:</strong> {{ $book->copies }} | <strong>Available:</strong> {{ $book->available_copies }}</p>
            <p><strong>Status:</strong> 
                <span class="{{ $book->available_copies > 0 ? 'status-available' : 'status-borrowed' }}">
...
function handleBarcodeScan(bookId) {
    ...
    const isAvailable = {{ $book->available_copies > 0 ? 'true' : 'false' }};
...
function downloadBarcode() {
    ...
    img.onload = function() {
        ...
        downloadLink.download = `barcode-{{ $book->id }}.png`;
